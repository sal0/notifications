        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                using (var db = new MainDbContext())
                {
                    ...
                    var provider4 = new Provider { Name = "Smtp Mail", RegDate = DateTime.Now };
                    ...
                    // Test Users
                    var user = db.Users.Add(new User { FirstName = "Ezeki", FullName = "Ezeki Zibzibadze", ExternalUserId = "1", MobileNumber = "995593159115", Email = "e.zibzibadze@altasoft.ge", ApplicationId = application.Id, RegDate = DateTime.Now });
                    ...
                    db.Messages.Add(new Message { Provider = provider4, UserId = user.Id, Subject = "Test X", Content = "Test4", RegDate = DateTime.Now });
